...
class RibbonGroupPlugin :
    ...
    public:
        /**
         * @brief       Constructs a new RibbonGroupPlugin instance which is a child of the parent.
         *
        ...
        /**
         * @brief       Returns a new instance of the RibbonGroup class, with the given parent.
         *
