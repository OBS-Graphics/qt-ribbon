...
/**
 * @brief       Ribbon combo box with label Qt Designer plugin.
 *
 * @details     Exposes the RibbonComboBox widget to Qt Designer, this class is responsible for creating instances of
...
class RibbonComboBoxPlugin :
    ...
    public:
        ...
        /**
         * @brief       Returns a new instance of the RibbonComboBox class, with the given parent.
         *
