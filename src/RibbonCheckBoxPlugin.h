...
/**
 * @brief       Ribbon check box Qt Designer plugin.
 *
 * @details     Exposes the RibbonCheckBox widget to Qt Designer, this class is responsible for creating instances of
 *              the widget and exposing properties and functions required for design.
 */
class RibbonCheckBoxPlugin :
        public QObject,
    ...
    public:
         ...
         */
        explicit RibbonCheckBoxPlugin(QObject *parent = nullptr);
        ...
        /**
         * @brief       Returns a new instance of the RibbonCheckBox class, with the given parent.
         *
